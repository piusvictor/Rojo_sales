...
<?php include('navbar.php')?>
    ...
    <!-- <a href="#" class="btn btn-outline-success btn-sm mb-4"  >Print product stock</a> -->
    </div>
  ...
  <div class="modal-dialog">
    ...
    <script>
        ...
        function getProducts(){
            var output="";
            $.ajax({
                url:"retrieve_purchase_products.php",
                method:"GET",
                dataType:"json",
                    ...
                    data.forEach((item,index)=>{
                        output+=`
                            <tr>
                                ...
                                <td>${item.rate}</td>                                                           
                                <td>
                                <a class="btn btn-primary btn-sm  edit-button" href="#" data-id="${item.id}" >Edit</a>
                                <a class="btn btn-danger btn-sm delete-btn" href="#" data-id="${item.id}">Delete</a>                                
                                </td>                                                           
                            </tr>                 
        ...
        function addProduct(product_name,unit,rate,qty){
            ...
            $.ajax({
                ...
                success:function(data){
                    console.log(data);
                    window.location.assign("http://localhost/Rojo_sales/view_purchase_products.php");
                },
                error:function(xhr,status,error){
                    console.log(xhr);
                }
