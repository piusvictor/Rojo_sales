...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="proforma-heading">SALES INVOICE</div>
            <div class="company-details">
                ...
                <div class="invoice-no">
                    <table  align="right" style="margin-right:-2px">
                        <tr><th class="table-padding1">Sale Invoice no:</th> <td class="table-padding" id="sale-invoice-no">2020-01</td></tr>
                ...
                <table class="product-table-font" class="" width="100.5%" style="margin-left:-2px;">
                    <thead>
                      <tr align="center" class="">
                        ...
                        <th width="28%" class="" >Item Description</th>
...
//alert(formatDate('Sun May 11,2014')); Usage
        ...
        function getInvoiceData(){
            $.ajax({
                   ...
                   //$('#grand-total').text(data.sales.sub_total+'.00');

                   //alert(data.sales.sub_total);
