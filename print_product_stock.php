...
<?php include('navbar.php')?>
    ...
    <a href="#" class="btn btn-success btn-sm mb-4"  id="print-stock">Print stock</a>
    </div>
        ...
        $(document).ready(function(){   
         ...
         function printStock() {
            var original_body=$('body').html();
                ...
                original_body=$('.table-div').html();
                $('#print-stock').css('visibility','hidden');
               // $('.back-button').css('visibility','hidden');
                window.print();
                original_body=temp_body;
                $('#print-stock').css('visibility','visible');
