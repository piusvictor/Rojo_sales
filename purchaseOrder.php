...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="proforma-heading">PURCHASE ORDER</div>
            <div class="company-details">
                ...
                <div class="invoice-no">
                    ...
                    <tr><th class="table-padding1">Purchase no:</th> <td class="table-padding" id="sale-invoice-no">2020-01</td></tr>
            ...
            <div class="payment-details">
                <b><i>Terms and Conditions:</i></b><br>1. Supplier should send all necessary export documents to ROJO AFRICA after shipment.<br>2. Goods should be in good Quality/finishing i.e good cutting edge, polished one side and no cracks.<br>3. Goods should be packed in such a way no breakage during shipment. Loose package <br>4. All goods should be produced as per agreed specification/measurement 
            </div>
            <div class="sign-stamp">
                <div class="sign">Authorized By ...............................................................
                    <p  style="margin-left:85px;margin-top:5px">Managing Director</p>
                    </div>
  ...
  //Function definition area
        ...
        function getInvoiceData(){
            $.ajax({
                    ...
                    url:"http://localhost/Rojo_sales/retrieve_purchase.php?id=<?=$_GET['id']?>",
                    method:"get",
                    cache:false,                    
                    dataType:"json",
